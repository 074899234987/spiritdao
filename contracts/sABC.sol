...
contract sABC is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sABC", "sABC", 9) ERC20Permit() {
    ...
    /**
        @notice increases ABC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess ABC
