...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    IUniswapV2Factory private constant joeFactory =
        IUniswapV2Factory(0xEdCFa39C2E01918c9d49a44F08d6a1FF5DD7FbE3);

    IUniswapV2Router02 private constant joeRouter =
        IUniswapV2Router02(0x6ECE4C6282178d45C7d7FE836134dd23Fa2c8014);

    address private constant wavaxTokenAddress =
        address(0x9389E175C9234aD044bAbcF8f450d32290802B33);
    ...
    constructor(address _DAO)
    {
        ...
        //allowedReserves
        allowedReserves[ITimeBondDepository(0xD254eE495620995f3FCd239417b5f8D6Ae28710f)] = 0xf16d3E16967594F66C9f7BC2Cd7f50E7194534bA; //DAI
        allowedReserves[ITimeBondDepository(0x5Ec38E3B6e12D2E4baB8b315E30790bfa72215Cb)] = 0x9389E175C9234aD044bAbcF8f450d32290802B33; //WETH
    }
