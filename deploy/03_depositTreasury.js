...
async function main() {
    ...
    // await usdc.approve(TREASURY_ADDRESS, amount)
    // console.log("SUCCESS: USDC -> approve TREASURY_ADDRESS")
    ...
    await usdc.transfer(TREASURY_ADDRESS, amount)
    console.log("SUCCESS: USDC -> transfer 1 USDC to Router")
}
